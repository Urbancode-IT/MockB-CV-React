...
export default function ResumeATSScoreChecker() {
    ...
    const handleDownloadPDF = () => {
        const content = `<html><head><style>body{font-family:Arial,sans-serif;margin:40px;color:#000;}h1{color:#D4C77A;}h2{border-bottom:2px solid #D4C77A;padding-bottom:4px;}</style></head>
